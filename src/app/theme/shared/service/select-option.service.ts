...
export class SelectOptionService {
  ...
  private static readonly SKILLS: Array<IOption> = [
    { value: 'co', label: 'Corel Draw' },
    { value: 'fg', label: 'Figma' },
    { value: 'ht', label: 'HTML' },
    { value: 'ad', label: 'Adobe X' },
    { value: 'an', label: 'Angular' },
    { value: 'ii', label: 'Illustrator' },
    { value: 'ja', label: 'Javascript' },
    { value: 'lo', label: 'Logo Design' },
    { value: 'ma', label: 'Material U' },
    { value: 'no', label: 'NodeJS' },
    { value: 'np', label: 'npm' },
    { value: 'ph', label: 'PhotoShop' },
    { value: 're', label: 'React' },
    { value: 'too', label: 'Reduxjs - tooltit' },
    { value: 'sa', label: 'SASS' }
  ];
  ...
  getSkills(): Array<IOption> {
    return this.cloneOptions(SelectOptionService.SKILLS);
  }

  loadSkills(): Observable<Array<IOption>> {
    return this.loadOptions(SelectOptionService.SKILLS);
  }
