...
export class NavItemComponent {
  ...
  // Constructor
  constructor(
    public router: Router, private location: Location, private locationStrategy: LocationStrategy) {
  ...
  logout() {
    ...
    if (this.item.title === 'Logout' && userType == ROLES.viewer) {
      this.router.navigate(['/login']);
      localStorage.clear();
      sessionStorage.clear();
    }
    else if (this.item.title === 'Logout' && userType == ROLES.tagger) {
      this.router.navigate(['auth/tagger-login']);
      localStorage.clear();
      sessionStorage.clear();
    }
    else if (this.item.title === 'Logout' &&
      (userType == ROLES.admin || userType == ROLES.superAdmin)) {
