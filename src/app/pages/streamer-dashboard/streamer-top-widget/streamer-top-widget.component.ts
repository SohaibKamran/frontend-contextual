...
@Component({
  selector: 'app-streamer-top-widget',
  templateUrl: './streamer-top-widget.component.html',
  styleUrls: ['./streamer-top-widget.component.scss']
})
export class StreamerTopWidgetComponent {
