...
@Component({
  selector: 'app-add-edit-advertiser',
  templateUrl: './add-edit-advertiser.component.html',
  styleUrls: ['./add-edit-advertiser.component.scss']
})
export class AddEditAdvertiserComponent implements OnInit {
advertiserDetailsForm: FormGroup
  ...
  constructor(public modalService: NgbModal,
    ...
    public advertiserService: ManageAdvertisersService,
  ...
  ngOnInit(): void {
    ...
    if (this.advertiserService.advertiserId !== null) {
      // console.log(this.advertiserService.advertiserId);
      // data = id
      this.id = this.advertiserService.advertiserId;
      //api call
      this.initForm();
