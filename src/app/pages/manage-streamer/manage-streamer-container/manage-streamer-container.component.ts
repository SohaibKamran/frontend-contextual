...
@Component({
  selector: 'app-manage-streamer-container',
  templateUrl: './manage-streamer-container.component.html',
  styleUrls: ['./manage-streamer-container.component.scss']
})
export class ManageStreamerContainerComponent {
